...
import implante from "../../../../assets/servicos/ortodontia1.png";

import implanteebook from "../../../../assets/servicos/ortodontia1.png";
...
export function MasterOrto(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='orto' className={styles.container}>
                ...
                <div className={styles.controlServices}>
                    ...
                    <div className={styles.controlTextTwo}>
                        <strong className={styles.text}>APARELHOS ORTODÔNTICOS</strong>
                    </div>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>APARELHOS ORTODÔNTICOS< br/> </strong>
