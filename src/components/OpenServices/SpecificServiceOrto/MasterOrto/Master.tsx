...
export function MasterOrto(){
    ...
    return(
        ...
        <div id='implante' className={styles.container}>
            ...
            <div className={styles.controlServices}>
                ...
                <div className={styles.controlTextTwo}>
                    <strong className={styles.text}>APARELHOS </strong><strong className={styles.textTwo}>ORTODONTICOS</strong>
                </div>
          ...
          <div className={styles.ebook}>
           ...
           <Image src={implanteebook} alt='' className={styles.ebookImage}/>
            ...
            <Image src={logo} alt='' className={styles.logo} />
                ...
                <strong className={styles.textEbook}>APARELHOS ORTODONTICOS< br/></strong>
