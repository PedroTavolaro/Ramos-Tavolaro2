...
import implante from "../../../../assets/servicos/proteses1.png";

import implanteebook from "../../../../assets/servicos/proteses1.png";
...
export function MasterProteses(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='proteses' className={styles.container}>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>PRÓTESES< br/></strong>
