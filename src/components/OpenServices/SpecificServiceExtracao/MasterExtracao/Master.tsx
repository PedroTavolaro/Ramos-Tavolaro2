...
import implante from "../../../../assets/servicos/extracao1.png";

import implanteebook from "../../../../assets/servicos/extracao1.png";
...
export function MasterExtracao(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='extracao' className={styles.container}>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>EXTRAÇÃO< br/></strong>
