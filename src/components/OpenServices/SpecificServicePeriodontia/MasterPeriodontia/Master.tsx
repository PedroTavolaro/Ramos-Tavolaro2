...
import implante from "../../../../assets/servicos/periodontia1.png";

import implanteebook from "../../../../assets/servicos/periodontia1.png";
...
export function MasterPeriodontia(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='periodontia' className={styles.container}>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>PERIODONTIA< br/></strong>
