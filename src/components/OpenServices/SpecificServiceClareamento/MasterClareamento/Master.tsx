...
import implante from "../../../../assets/servicos/clareamento.jpg";

import implanteebook from "../../../../assets/servicos/clareamento.jpg";
...
export function MasterClareamento(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='clareamento' className={styles.container}>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>CLAREAMENTO< br/></strong>
