...
import implante from "../../../../assets/servicos/limpeza1.png";

import implanteebook from "../../../../assets/servicos/limpeza1.png";
...
export function MasterLimpeza(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='limpeza' className={styles.container}>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>LIMPEZA< br/></strong>
