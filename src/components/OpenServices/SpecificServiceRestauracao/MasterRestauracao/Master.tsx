...
import implante from "../../../../assets/servicos/restauracao1.png";

import implanteebook from "../../../../assets/servicos/restauracao1.png";
...
export function MasterRestauracao(){
    ...
    return(
        <div className={styles.SpecificService}>
            ...
            <div id='restauracao' className={styles.container}>
              ...
              <div className={styles.ebook}>
               ...
               <Image src={implanteebook} alt='' className={styles.ebookImage}/>
                ...
                <Image src={logo} alt='' className={styles.logo} />
                    ...
                    <strong className={styles.textEbook}>RESTAURAÇÕES< br/></strong>
